...
public class GenreController {
    ...
    public void setGenreList() throws ClassNotFoundException, SQLException {
        ...
        String query2 = "SELECT * FROM MainTable where Genre is not NULL GROUP BY Genre ORDER BY Genre;";
    ...
    @FXML
    public void playGenreList(MouseEvent event) throws IOException, SQLException, ClassNotFoundException {
        String genre = genreList.getSelectionModel().getSelectedItem().toString();
        ...
        controller.showGenreList(genre);
