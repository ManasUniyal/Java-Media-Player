...
public class ArtistController {
    ...
    public void setArtistList() throws ClassNotFoundException, SQLException {

        Class.forName("com.mysql.cj.jdbc.Driver");
        String url2 = "jdbc:mysql://localhost:3306/media";
        Connection connect = DriverManager.getConnection(url2, "root", "utkarshsql");

        String query2 = "SELECT Artist FROM MainTable where Artist is not NULL GROUP BY Artist ORDER BY Artist;";
    ...
    @FXML
    public void playArtistList(MouseEvent event) throws IOException, SQLException, ClassNotFoundException {
        String artist = artistList.getSelectionModel().getSelectedItem().toString();
        ...
        controller.showArtistList(artist);
        controller.showRating(FXMLDocumentController.songName);
        controller.showRating(FXMLDocumentController.songName);
        controller.showArtistName(artist);
    ...
    @FXML
    public void playlistButton(ActionEvent event) throws SQLException, IOException, ClassNotFoundException {
