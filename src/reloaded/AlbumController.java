...
public class AlbumController {
    ...
    @FXML
    public void playAlbumList(MouseEvent event) throws IOException, SQLException, ClassNotFoundException {
        String album = albumList.getSelectionModel().getSelectedItem().toString();
        ...
        controller.showAlbumList(album);
